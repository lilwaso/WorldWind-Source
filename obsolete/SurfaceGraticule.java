 ...
 * @version $Id: SurfaceGraticule.java 13646 2010-08-20 18:15:43Z dcollins $
 */
public class SurfaceGraticule extends AbstractSurfaceRenderable
{
    ...
    public List<Sector> getSectors(DrawContext dc)
    {
        ...
        return Arrays.asList(Sector.FULL_SPHERE);
    }
    ...
    {
        double targetResolution = Math.max(this.getMinResolution(),
            sector.getDeltaLatDegrees() / this.getDensity());    // degrees
