...
public class VirtualEarthLogo implements OrderedRenderable
{
	...
	private void drawIcon(DrawContext dc)
	{
		...
		try
		{
			...
			Texture iconTexture = dc.getTextureCache().getTexture(this);
			if (iconTexture == null)
			{
				this.initializeTexture(dc);
				iconTexture = dc.getTextureCache().getTexture(this);
				if (iconTexture == null)
				{
					// TODO: log warning
					return;
