 ...
 *
 * @author jym
 * @version $Id: BasicView.java 15147 2011-03-29 21:00:42Z pabercrombie $
 */
public class BasicView extends WWObjectImpl implements View
{
    ...
    /**
     * Update the modelview state identifier. This method should be called whenever one of the fields that affects
     * the modelview matrix is changed.
     */
