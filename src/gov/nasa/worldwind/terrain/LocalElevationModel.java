 ...
 *
 * @author tag
 * @version $Id: LocalElevationModel.java 15524 2011-05-27 06:15:24Z tgaskins $
 */
public class LocalElevationModel extends AbstractElevationModel
{
    ...
    public void addElevations(File file) throws IOException
    {
        ...
        if (!DataImportUtil.isElevations(reader.readMetadata(file, null)))
        {
    ...
    protected static class LocalTile
    {
        ...
        /**
         * Determines whether a value signifies missing data -- voids. This method not only tests the value agains the
