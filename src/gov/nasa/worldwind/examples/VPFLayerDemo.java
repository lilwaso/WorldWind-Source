 ...
 * <p/>
 * Applications must include the GeoSym JAR file <code>geosym-2ed-png.jar</code> in the Java class-path in order to
 * display VPF shapes with the appropriate color, style, and icon. If this JAR file is not in the Java class-path,
 * VPFLayer outputs the following message in the World Wind log: <code>WARNING: GeoSym style support is disabled</code>.
 * In this case, VPF shapes are displayed as gray outlines, and icons are displayed as a gray question mark.
 *
 * @author dcollins
 * @version $Id: VPFLayerDemo.java 15685 2011-06-21 17:45:05Z dcollins $
 */
