 ...
 *
 * @author dcollins
 * @version $Id: KMLFeatureTreeNode.java 14917 2011-03-09 17:40:49Z dcollins $
 */
public class KMLFeatureTreeNode extends BasicTreeNode
{
    ...
    {
        super(feature != null ?
            (feature.getName() != null ? feature.getName() : feature.getClass().getSimpleName()) : "");
    ...
    protected void makeFeatureDescription()
    {
        ...
        {
            text = ((KMLSnippet) snippet).getCharacters();
        }
        else
        {
