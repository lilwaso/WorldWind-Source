 ...
 *
 * @author dcollins
 * @version $Id: LayerTree.java 15555 2011-06-04 21:46:09Z pabercrombie $
 * @see LayerTreeModel
 * @see LayerTreeNode
 */
public class LayerTree extends BasicTree
{
    ...
    protected static final Offset DEFAULT_OFFSET = new Offset(20d, 140d, AVKey.PIXELS, AVKey.PIXELS);
