 ...
 *
 * @author pabercrombie
 * @version $Id: BalloonController.java 15197 2011-04-05 01:30:35Z pabercrombie $
 */
public class BalloonController extends MouseAdapter implements SelectListener
{
     ...
     * does not have a balloon, a balloon may be created. {@link #canShowBalloon} determines if a balloon will be
     * created.
     *
        ...
        if (balloon != null)
        {
            ...
            if (!balloon.isVisible())
            {
                ...
                else
                {
                    ...
                    {
                        this.hideBalloon(); // Hide previously displayed balloon, if any
                        this.showBalloon(balloon, point);
                    }
                    ...
                    else
                    {
                        ...
                        this.hideBalloon();
                        this.showBalloon(balloon, center);
                    }
                }
            }
        }
    ...
    public boolean canShowBalloon(KMLAbstractFeature feature)
    {
        ...
        return (hasBalloonStyle || !WWUtil.isEmpty(feature.getDescription())) && !isBalloonHidden;
    }
     ...
     * the feature. {@link #canShowBalloon} determines if a balloon will be created for the feature.
     *
     * @param pickedObject PickedObject to inspect. May not be null.
     *
    ...
    protected void showBalloon(Balloon balloon, Position position)
    {
        ...
        if (this.mustAdjustPosition(balloon))
            this.adjustPosition(balloon, new Point((int) screenPoint.x, (int) screenPoint.y));
