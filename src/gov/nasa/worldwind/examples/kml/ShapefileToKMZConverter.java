 ...
 *
 * @author pabercrombie
 * @version $Id: ShapefileToKMZConverter.java 14632 2011-02-02 20:31:26Z pabercrombie $
 */
public class ShapefileToKMZConverter
{
    ...
    protected static void convertFile(File file) throws IOException, XMLStreamException
    {
        ...
        // Set the export mode so that polygon records with height are exported as extruded polygons
        shapeFile.setValue(AVKey.EXPORT_MODE, AVKey.EXTRUDED);
