 ...
 *
 * @author pabercrombie
 * @version $Id: KMLOrbitViewController.java 14521 2011-01-19 22:03:16Z pabercrombie $
 */
public class KMLOrbitViewController extends KMLViewController
{
        ...
        Angle heading, Angle pitch, Angle roll, long timeToMove, int altitudeMode)
    {
        ...
        ViewElevationAnimator zoomAnimator = new ViewElevationAnimator(globe,orbitView.getZoom(), range, orbitView.getCenterPosition(), eyePosition, WorldWind.ABSOLUTE,
