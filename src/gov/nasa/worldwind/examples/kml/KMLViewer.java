 ...
 *
 * @author tag
 * @version $Id: KMLViewer.java 15470 2011-05-20 01:17:19Z tgaskins $
 */
public class KMLViewer extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            this.layerTree = new LayerTree(new Offset(20d, 160d, AVKey.PIXELS, AVKey.PIXELS));
        ...
        protected void addKMLLayer(KMLRoot kmlRoot)
        {
            ...
            // Associate our View with the KMLRoot's Link controller. This will allow the controller to refresh KML
            // links when the view stops moving and the link's refresh mode is "onStop".
            kmlRoot.getLinkController().setWorldWindow(this.getWwd());
