 ...
 *
 * @author dcollins
 * @version $Id: AnalyticSurfaceDemo.java 15663 2011-06-17 21:15:40Z dcollins $
 */
public class AnalyticSurfaceDemo extends ApplicationTemplate
{
    protected static final String DATA_URL = "http://worldwind.arc.nasa.gov/java/demos/data/wa-precip-24hmam.zip";
    ...
    {
        BufferWrapperRaster raster = loadZippedBILData(DATA_URL);
        if (raster == null)
            return;
