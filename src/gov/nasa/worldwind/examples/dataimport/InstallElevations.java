 ...
 * to place the intalled elevations. This example uses the FileStore's install location. </li> <li>Compute a unique
 ...
 *
 * @author tag
 * @version $Id: InstallElevations.java 15674 2011-06-20 20:02:32Z dcollins $
 */
public class InstallElevations extends ApplicationTemplate
{
    ...
    // TODO: need a more distinguishable set of elevations; these are very shallow
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected void installElevations()
        {
            ...
            final ElevationModel em = installElevations("Snohomish WA LiDAR DTM", sourceFile, fileStore);
            if (em == null)
                return;
