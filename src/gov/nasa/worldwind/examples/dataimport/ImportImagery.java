...
/**
 * This example demonstrates how to import imagery. It imports a GeoTIFF image file and displays it as a {@link
 * SurfaceImage}.
 *
 * @author tag
 * @version $Id: ImportImagery.java 14337 2010-12-29 04:38:03Z tgaskins $
 */
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected void importImagery()
        {
            try
            {
                ...
                if (!DataImportUtil.isImagery(reader.readMetadata(sourceFile, null)))
