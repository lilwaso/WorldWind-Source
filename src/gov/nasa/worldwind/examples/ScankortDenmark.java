 ...
 * <p/>
 * The data is from Denmark.  Details for loading the imagery can be found in: {@link
 * config/Earth/ScankortDenmarkImageLayer.xml} while information for loading the elevation data is in: {@link
 * config/Earth/ScankortDenmarkDSMElevationModel.xml}
 *
 * @author dcollins
 * @version $Id: ScankortDenmark.java 15652 2011-06-16 20:08:32Z ccrick $
 */
