 ...
 * week that the data was collected, by the hour of day that the data was collected, or by a simple color ramp. Use
 * the controls in the lower left corner of the window to change the ordering mode.
 *
 * @author Patrick Murris
 * @version $Id: MarkersOrder.java 15655 2011-06-16 22:08:28Z pabercrombie $
 */
