 ...
 * the rigid shapes (Ellipsoid, Box, Cylinder, Cone, Pyramid, Wedge) as well as ExtrudedPolygon.  The RigidShapeBuilder
 * user interface allows the user to select the desired shape from a dropdown menu, create an instance of it with the
 * click of a button, and specify an "edit mode" for modifying the shape: move, scale, rotate or skew.  Numerous shapes
 * may be created and placed on the globe together, but only one may be selected and edited at any given time.
 * <p/>
 * Keyboard shortcuts allow the user to toggle easily between the various edit modes.  The shortcuts are as follows:
 * <p/>
 * Ctrl-Z:  move Ctrl-X:  scale Ctrl-C:  rotate Ctrl-V:  skew
 *
 * @author ccrick
 * @version $Id: RigidShapeBuilder.java ccrick $
 */
...
public class RigidShapeBuilder extends ApplicationTemplate
{
        ...
        MouseListener, CaretListener
    {
        ...
        protected void doOpenImageFile()
        {
            if (this.fileChooser == null)
            {
                ...
                this.fileChooser.addChoosableFileFilter(new ImageIOFileFilter(this.imageReader));
            }
    ...
    protected static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        //protected RenderableLayer toolTipLayer;
