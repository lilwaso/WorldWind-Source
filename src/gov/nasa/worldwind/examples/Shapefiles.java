 ...
 * @version $Id: Shapefiles.java 14463 2011-01-14 09:41:06Z tgaskins $
 */
public class Shapefiles extends ApplicationTemplate
{
    ...
    public static class WorkerThread extends Thread
    {
        ...
        public void run()
        {
            try
            {
                final List<Layer> layers = this.makeShapefileLayers(this.source);
        ...
        protected List<Layer> makeShapefileLayers(Object source)
        {
