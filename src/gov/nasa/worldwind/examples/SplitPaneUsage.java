 ...
 *
 * @author tag
 * @version $Id: SplitPaneUsage.java 14793 2011-02-23 01:23:01Z tgaskins $
 */
public class SplitPaneUsage
{
    ...
    private static class AppFrame extends JFrame
    {
        ...
        public AppFrame()
        {
            ...
            buttonPanel.add(new JButton("Push Me Left"), BorderLayout.WEST);
            buttonPanel.add(new JButton("Push Me Center"), BorderLayout.CENTER);
            buttonPanel.add(new JButton("Push Me Right"), BorderLayout.EAST);
            ...
            verticalSplitPane.setBottomComponent(buttonPanel);
