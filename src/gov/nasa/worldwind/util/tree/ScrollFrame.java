 ...
 *
 * @author pabercrombie
 * @version $Id: ScrollFrame.java 15594 2011-06-09 22:44:48Z pabercrombie $
 */
public class ScrollFrame extends DragControl implements PreRenderable, Renderable
{
    ...
    /** Indicates that the rendered tiles must be updated. */
    protected boolean mustUpdateTiles;
    /**
     ...
     *
     * @return {@code true} if any of the tiles need to be udpated.
     */
    protected boolean mustUpdateTiles()
    {
    ...
    public void preRender(DrawContext dc)
    {
        ...
        if (this.intersectsFrustum(dc) && this.mustUpdateTiles())
        {
            try
            {
    ...
    public void updateBounds(DrawContext dc)
    {
        ...
        this.frameBounds = new Rectangle(upperLeft.x, upperLeft.y - this.frameSize.height, this.frameSize.width,
            this.frameSize.height);
    ...
    public void selected(SelectEvent event)
    {
        ...
        Rectangle titleBarBounds = new Rectangle((int) this.screenPoint.getX() + this.frameBorder,
            (int) this.screenPoint.getY() + this.frameBorder * 2, this.innerBounds.width, this.titleBarHeight);
