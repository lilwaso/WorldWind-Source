 ...
 *
 * @author pabercrombie
 * @version $Id: ScheduledThreadedTaskService.java 15134 2011-03-28 23:41:44Z pabercrombie $
 */
public class ScheduledThreadedTaskService extends WWObjectImpl
    implements ScheduledTaskService, Thread.UncaughtExceptionHandler
{
     ...
     */
    public ScheduledThreadedTaskService()
    {
    ...
    protected class ScheduledTaskExecutor extends ScheduledThreadPoolExecutor
    {
            ...
            super(poolSize,
                new ThreadFactory()
                {
                    public Thread newThread(Runnable runnable)
                    {
                        ...
                        thread.setUncaughtExceptionHandler(ScheduledThreadedTaskService.this);
                        return thread;
                    }
                },
                new DiscardPolicy()
        ...
        protected void beforeExecute(Thread thread, Runnable runnable)
        {
            ...
            if (ScheduledThreadedTaskService.this.activeTasks.contains(runnable))
            {
            ...
            ScheduledThreadedTaskService.this.activeTasks.add(runnable);
        ...
        protected void afterExecute(Runnable runnable, Throwable throwable)
        {
            ...
            ScheduledThreadedTaskService.this.activeTasks.remove(runnable);
