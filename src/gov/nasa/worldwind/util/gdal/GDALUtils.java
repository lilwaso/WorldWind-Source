 ...
 * @version $Id: GDALUtils.java 15718 2011-06-23 08:21:56Z garakl $
 */
...
//    protected static BufferedImage makeCompatibleImage(BufferedImage img)
//    {
//        if (null == img)
//            return null;
//
...
//        if( null != cm )
//        {
//            int numOfBands = cm.getNumComponents();
//            if( numOfBands == 3 )
//                newType = BufferedImage.TYPE_INT_RGB;
//            else if( numOfBands == 4 )
//                newType = BufferedImage.TYPE_INT_ARGB;
//            else if( numOfBands == 1 )
//            {
//                int bitsPerColor[] = cm.getComponentSize();
//                ColorSpace cs = cm.getColorSpace();
//
//                if( null != bitsPerColor && bitsPerColor.length > 0
//                    && null != cs && ColorSpace.TYPE_GRAY == cs.getType())
//                {
//
//                    int bpc = bitsPerColor[0];
//                    if( bpc <= 8 )
//                        newType = BufferedImage.TYPE_BYTE_GRAY;
//                    else
//                        newType = BufferedImage.TYPE_USHORT_GRAY;
//                }
//            }
//        }
//
//        BufferedImage dest = new BufferedImage(w, h, newType );
//        Graphics2D g2d = dest.createGraphics();
//        java.awt.Composite prevComposite = g2d.getComposite();
//        g2d.setComposite(java.awt.AlphaComposite.Src);
//        g2d.drawImage(img, 0, 0, w, h, 0, 0, w, h, null);
