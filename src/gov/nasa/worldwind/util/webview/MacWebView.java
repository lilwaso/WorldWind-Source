...
/**
 * @author dcollins
 * @version $Id: MacWebView.java 15517 2011-05-26 21:47:27Z dcollins $
 */
public class MacWebView extends AbstractWebView
{
    /**
     * The redraw request delay: 10 milliseconds. Used to initiate a redraw when the native WebViewWindow cannot load
     * its buffer into the MacWebView's OpenGL texture during the current frame.
     */
    ...
    protected class MacWebViewTexture extends WebViewTexture
    {
        ...
        /**
         * The WebView update time when the texture was last updated. Initially set to an invalid update time to ensure
         * that the texture is updated at least once.
         */
        ...
        protected void displayInTexture(DrawContext dc, Texture texture)
        {
            ...
            if (MacWebViewJNI.canDisplayInTexture(webViewWindowPtr))
            {
            ...
            {
                dc.setRedrawRequested(REDRAW_DELAY);
            }
        }
    }
}
