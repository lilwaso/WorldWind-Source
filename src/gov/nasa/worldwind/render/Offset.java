 ...
 * the placemark image, {@link AVKey#FRACTION}, which indicates the units are fractions of the placemark image width and
 * height, and {@link AVKey#INSET_PIXELS}, which indicates units of pixels but with origin in the upper left.
 * <p/>
 * This class implements the functionality of a KML <i>Offset</i>.
 *
 * @author tag
 * @version $Id: Offset.java 14476 2011-01-15 00:21:15Z dcollins $
 */
public class Offset
{
    protected Double x;
