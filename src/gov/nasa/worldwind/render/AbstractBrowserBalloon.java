 ...
 *
 * @author dcollins
 * @version $Id: AbstractBrowserBalloon.java 15583 2011-06-08 20:01:43Z pabercrombie $
 */
public abstract class AbstractBrowserBalloon extends AbstractBalloon implements OrderedRenderable, HotSpot, Disposable
{
    ...
    /**
     * The browser balloon's default native size: 330x145. This default size is used when a balloon's size is configured
     ...
     * content size.
     */
    protected static final Dimension DEFAULT_NATIVE_SIZE = new Dimension(350, 200);
    /**
