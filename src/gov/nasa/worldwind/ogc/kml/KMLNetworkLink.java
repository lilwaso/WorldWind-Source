 ...
 *
 * @author tag
 * @version $Id: KMLNetworkLink.java 15695 2011-06-22 17:42:16Z pabercrombie $
 */
public class KMLNetworkLink extends KMLAbstractFeature implements PropertyChangeListener
{
    ...
    protected void retrieveNetworkResource(String address)
    {
        ...
        KMLRoot root = this.getRoot().resolveNetworkLink(address, this.isLinkCacheable(), updateTime);
        if (root != null)
        {
            this.setNetworkResource(root);
