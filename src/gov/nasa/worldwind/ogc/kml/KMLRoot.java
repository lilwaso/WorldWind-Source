 ...
 *
 * @author tag
 * @version $Id: KMLRoot.java 15636 2011-06-15 23:52:45Z pabercrombie $
 */
public class KMLRoot extends KMLAbstractObject implements KMLRenderable
{
     ...
     * @throws IllegalArgumentException if the {@code linkBase} is null.
     */
    public KMLRoot resolveNetworkLink(String link, boolean cacheRemoteFile, long updateTime)
    {
        Object o = null;
        try
        {
            ...
            if (o == null)
            {
                url = WorldWind.getDataFileStore().requestFile(link, cacheRemoteFile);
                if (url != null)
                {
                ...
                o = this.resolveRemoteReference(link, null, cacheRemoteFile);
            }
        }
        catch (Exception e)
        {
