 ...
 *
 * @author tag
 * @version $Id: KMLPointPlacemarkImpl.java 15463 2011-05-18 20:50:12Z pabercrombie $
 */
public class KMLPointPlacemarkImpl extends PointPlacemark implements KMLRenderable
{
    ...
    public void render(KMLTraversalContext tc, DrawContext dc)
    {
        ...
        {
            if (balloon instanceof GlobeBalloon)
            {
                GlobeBalloon globeBalloon = (GlobeBalloon) balloon;
                globeBalloon.setAltitudeMode(this.getAltitudeMode());
                globeBalloon.setPosition(this.position);
            }
            balloon.render(dc);
        }
