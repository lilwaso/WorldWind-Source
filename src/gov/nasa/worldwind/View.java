 ...
 *
 * @author Paul Collins
 * @version $Id: View.java 15147 2011-03-29 21:00:42Z pabercrombie $
...
public interface View extends WWObject, Restorable
{
    ...
    /**
     * Returns the most up-to-date location of the eye in geographic coordinates. Unlike {@link #getEyePosition} and
    ...
    /**
     * Sets the horizontal field-of-view angle (the angle of visibility) to the specified <code>fieldOfView</code>.
    ...
    /**
     * Computes a line, in model coordinates, originating from the eye point, and passing through the point contained
    ...
    /**
     * Computes the intersection of a line originating from the eye point (passing through (x, y)) with the last
