 ...
 * @version $Id: SkyGradientLayer.java 15233 2011-04-08 03:33:49Z tgaskins $
 */
public class SkyGradientLayer extends AbstractLayer
{
    ...
    protected boolean isValid(DrawContext dc)
    {
        ...
        return dlResource != null && Math.abs(this.lastRebuildHorizon - dc.getView().getFarClipDistance()) <= 100;
    }
    ...
    protected int[] updateSkyDome(DrawContext dc)
    {
        ...
        double tangentialDistance = view.getFarClipDistance();
