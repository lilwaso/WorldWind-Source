...
/**
 * @author Tom Gaskins
 * @version $Id: AVKey.java 15536 2011-06-02 16:25:13Z ccrick $
 */
public interface AVKey // TODO: Eliminate unused constants, if any
{
    ...
    final String EXPORT_MODE = "gov.nasa.worldwind.avkey.ExportMode";
    final String EXTENT = "gov.nasa.worldwind.avkey.Extent";
    final String EXTERNAL_LINK = "gov.nasa.worldwind.avkey.ExternalLink";
    final String EXTRUDED = "gov.nasa.worldwind.avkey.Extruded";
