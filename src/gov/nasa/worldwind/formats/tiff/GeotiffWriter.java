 ...
 * @version $Id: GeotiffWriter.java 15008 2011-03-19 04:02:49Z garakl $
 */
...
public class GeotiffWriter
{
    ...
    public void write(DataRaster raster) throws IOException, IllegalArgumentException
    {
        ...
        {
            this.writeRaster((ByteBufferRaster) raster);
        }
    }
    ...
    value: AVKey.ELEVATION_UNIT_FEET or AVKey.ELEVATION_UNIT_METER (default, if not specified)
...
//            break;
    ...
    private void appendGeoTiff(ArrayList<TiffIFDEntry> ifds, AVList params) throws IOException, IllegalArgumentException
    {
        ...
        if (params.hasKey(AVKey.SECTOR))
        {
            ...
            if (params.hasKey(AVKey.MISSING_DATA_SIGNAL) || params.hasKey(AVKey.MISSING_DATA_SIGNAL))
            {
                offset = this.theChannel.position();
...
//            throw new IllegalArgumentException(msg);
    ...
    private void writeGeographicElevationGeoKeys(ArrayList<TiffIFDEntry> ifds, AVList params) throws IOException
    {
        ...
        if (isElevation(params) && isGeographic(params))
        {
            ...
            {
                if (AVKey.ELEVATION_UNIT_FEET.equals(params.getValue(AVKey.ELEVATION_UNIT)))
    ...
    public void writeRaster(ByteBufferRaster raster) throws IOException, IllegalArgumentException
    {
        if (raster == null)
        {
            String msg = Logging.getMessage("nullValue.RasterIsNull");
