 ...
 * @version $Id: BasicRasterServer.java 15568 2011-06-07 06:42:05Z garakl $
 */
...
//                        Logging.logger().severe(message);
                    ...
                    {
                        if (DataImportUtil.isImagery(rasterMetadata))
                        {
                            this.setValue(AVKey.PIXEL_FORMAT, AVKey.IMAGE);
                        }
                        else if (DataImportUtil.isElevations(rasterMetadata))
                        {
     ...
     *
     * @param reqParams This is a required parameter, must not be null or emtpy; Must contain AVKey.WIDTH, AVKey.HEIGHT,
    ...
    public DataRaster composeRaster(AVList reqParams) throws IllegalArgumentException, WWRuntimeException
    {
        ...
        try
        {
            ...
            else if (DataImportUtil.isImagery(this))
            {
