 ...
 * @version $Id: GDALDataRaster.java 15613 2011-06-14 20:33:08Z dcollins $
 */
...
//                throw new WWRuntimeException( message );
    ...
    protected void doDrawOnTo(DataRaster canvas)
    {
        ...
        try
        {
            DataRaster raster = this.doGetSubRaster(clipRect.width, clipRect.height, overlap, canvas.copy());
...
//            return this.dsVRT;
    ...
    protected Double calcNoDataForDestinationRaster(AVList destParams)
    {
        ...
        if (null == nodata && AVKey.ELEVATION.equals(this.getValue(AVKey.PIXEL_FORMAT)))
        {
