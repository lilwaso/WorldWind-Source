 ...
 * @version $Id: CachedDataRaster.java 15568 2011-06-07 06:42:05Z garakl $
 */
        ...
        synchronized (this.rasterRetrievalLock)
        {
            ...
            if (this.rasterCache == null || !this.rasterCache.contains(this.dataSource))
            {
                ...
                catch (Throwable t)
                {
                    ...
                    rasters = null;
                    String message = Logging.getMessage("generic.CannotCreateRaster", this.composeExceptionReason(t));
                    Logging.logger().severe(message);
