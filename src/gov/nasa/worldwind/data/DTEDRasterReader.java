 ...
 * @version $Id: DTEDRasterReader.java 14246 2010-12-14 22:32:28Z garakl $
 */
...
public class DTEDRasterReader extends AbstractDataRasterReader
{
    ...
    protected DataRaster[] doRead(Object source, AVList params) throws IOException
    {
        ...
        return new DataRaster[]{DTED.read(file)};
    }
...
//    {
//        DTEDRasterReader reader = new DTEDRasterReader();
//
//        File file = new File( "/Volumes/r5/NASA/data/elevations/DTED/DTED0/e007/n22.dt0");
//        AVList params = new AVListImpl();
//
//        try
//        {
//            reader.canRead( file, params );
//            DataRaster[] rasters = reader.read( file, params );
//            DataRaster raster = ( null != rasters && rasters.length > 0 ) ? rasters[0] : null;
//            if( null != raster )
//                Logging.logger().info( raster.getWidth() + " x " + raster.getHeight() );
//        }
//        catch (IOException e)
//        {
