...
/**
 * @author dcollins
 * @version $Id: BufferedDataRaster.java 15568 2011-06-07 06:42:05Z garakl $
 */
public abstract class BufferedDataRaster extends AbstractDataRaster
{
    ...
    public void drawOnTo(DataRaster canvas)
    {
        ...
        this.doDrawOnTo((BufferedDataRaster) canvas);
    }
    ...
    protected void doDrawOnTo(BufferedDataRaster canvas)
    {
