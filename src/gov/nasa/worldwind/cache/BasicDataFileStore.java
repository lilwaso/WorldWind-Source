 ...
 *
 * @author Tom Gaskins
 * @version $Id: BasicDataFileStore.java 15636 2011-06-15 23:52:45Z pabercrombie $
 */
public class BasicDataFileStore extends AbstractFileStore
{
    ...
    protected String removePrivateQueryParameters(String queryString)
    {
        ...
        // specify the regular expression directive "(?i)" to enable case-insensitive matchine. The regular expression
